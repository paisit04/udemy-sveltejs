...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 39, 4, 1030);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 32, 2, 772);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$3, 33, 2, 791);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$3, 31, 0, 765);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 42, 6, 816);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (40:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 37, 2, 666);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 38, 2, 682);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 36, 0, 654);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 17, 4, 329);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$1, 18, 4, 350);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$1, 19, 4, 371);
    			add_location(div0, file$1, 16, 2, 319);
    			add_location(div1, file$1, 21, 2, 403);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$1, 15, 0, 295);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 21, 2, 413);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file, 20, 0, 401);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
