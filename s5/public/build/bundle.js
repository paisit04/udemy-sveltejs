    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 14, 4, 297);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$4, 12, 4, 241);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 10, 2, 146);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 13, 4, 224);
    			attr_dev(h2, "class", "svelte-enhpap");
    			add_location(h2, file$2, 14, 4, 245);
    			attr_dev(p0, "class", "svelte-enhpap");
    			add_location(p0, file$2, 15, 4, 269);
    			attr_dev(header, "class", "svelte-enhpap");
    			add_location(header, file$2, 12, 2, 211);
    			...
    			add_location(img, file$2, 18, 4, 324);
    			attr_dev(div0, "class", "image svelte-enhpap");
    			add_location(div0, file$2, 17, 2, 300);
    			attr_dev(p1, "class", "svelte-enhpap");
    			add_location(p1, file$2, 21, 4, 396);
    			attr_dev(div1, "class", "content svelte-enhpap");
    			add_location(div1, file$2, 20, 2, 370);
    			attr_dev(footer, "class", "svelte-enhpap");
    			add_location(footer, file$2, 23, 2, 428);
    			attr_dev(article, "class", "svelte-enhpap");
    			add_location(article, file$2, 11, 0, 199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 54, 2, 1619);
    			attr_dev(main, "class", "svelte-1ab3vfs");
    			add_location(main, file, 53, 0, 1610);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
